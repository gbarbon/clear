// Version 1.9.5 three-forcegraph - https://github.com/vasturiano/three-forcegraph
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('three')) :
	typeof define === 'function' && define.amd ? define(['three'], factory) :
	(global.ThreeForceGraph = factory(global.THREE));
...
var ngraph = { graph: ngraph_graph, forcelayout: ngraph_forcelayout, forcelayout3d: ngraph_forcelayout3d };
...
var ForceGraph = Kapsule({
  ...
  stateInit: function stateInit() {
    return {
      d3ForceLayout: d3ForceSimulation().force('link', d3ForceLink()).force('charge', d3ForceManyBody()).force('center', d3ForceCenter()).stop(),
      engineRunning: false
    };
  },
