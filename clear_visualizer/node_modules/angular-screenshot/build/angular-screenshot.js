...
var _angular = __webpack_require__(305);

var angular = _interopRequireWildcard(_angular);

var _directives = __webpack_require__(116);
...
var _screenshot = __webpack_require__(118);

var _screenshot2 = _interopRequireDefault(_screenshot);

var _screenshotToolbox = __webpack_require__(117);
...
var _domToImage = __webpack_require__(303);
...
var screenshot = function screenshot() {
   var screenshotController = function screenshotController($scope, $element, $compile, $timeout, $window) {
      ...
      var downloadFull = function downloadFull() {
         self.isOpen = false;
         $timeout(function () {
            var elementSelector = getElementSelector();
            var element = elementSelector[0];
            ...
            _domToImage2.default.toPng(element, options).then(function (imageUrl) {
               return _utils.domprocess.downloadByUrl(imageUrl, self.filename);
...
exports.domprocess = undefined;

var _domProcess = __webpack_require__(119);
