...
(function (global, factory) {
  ...
  (global.ThreeRenderObjects = factory(global.THREE));
  					...
  					if (missing === 0 && func) {
  						...
  						if (global) {
  							...
  							if (module.exports) { //node
  								...
  								undefined((window.GreenSockAMDPath ? window.GreenSockAMDPath + "/" : "") + ns.split(".").pop(), [], function() { return cl; });
  							}
  						}
  ...
  var threeRenderObjects = Kapsule({
    ...
    init: function init(domNode, state) {
      ...
      state.renderer = new three$1.WebGLRenderer({ alpha: true });
      state.renderer.setClearColor(new three$1.Color(state.backgroundColor), tinycolor(state.backgroundColor).getAlpha());
